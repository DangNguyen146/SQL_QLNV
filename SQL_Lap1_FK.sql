CREATE DATABASE LAB1_PRIMARYKEY
GO
USE LAB1_PRIMARYKEY
GO
...
CREATE TABLE HOADON (
	...
	TRIGIA MONEY,
	CONSTRAINT FK_KH
	FOREIGN KEY(MAKH) REFERENCES dbo.KHACKHANG(MAKH),
	CONSTRAINT FK_NV
...
INSERT INTO dbo.KHACKHANG VALUES('KH01', 'Nguyen Van A', '731 Tran Hung Dao, Q5, TpHCM', '08823451', '19601022', 13060000, '20060722')
INSERT INTO dbo.KHACKHANG VALUES('KH02', 'Tran Ngoc Han', '23/5 Nguyen Trai, Q5, TpHCM', '0908256478', '19740403', 280000, '20060730')
INSERT INTO dbo.KHACKHANG VALUES('KH03', 'Tran Ngoc Linh', '45 Nguyen Canh Chan, Q1, TpHCM', '0938776266', '19800612', 3860000, '20060805')
INSERT INTO dbo.KHACKHANG VALUES('KH04', 'Tran Minh Long', '50/34 Le Dai Hanh, Q10, TpHCM', '0917325476', '19650309', 250000, '20061002')
INSERT INTO dbo.KHACKHANG VALUES('KH05', 'Le Nhat Minh', '34 Truong Dinh, Q3, TpHCM', '08246108', '19500310', 21000, '20061028')
INSERT INTO dbo.KHACKHANG VALUES('KH06', 'Le Hoai Thuong', '227 Nguyen Van Cu, Q5, TpHCM', '08631708', '19811231', 915000, '20061124')
INSERT INTO dbo.KHACKHANG VALUES('KH07', 'Nguyen Van Tam', '32/3 Tran Binh Trong, Q5, TpHCM', '0916783565', '19710406', 12500, '20061201')
INSERT INTO dbo.KHACKHANG VALUES('KH08', 'Pham Thi Thanh', '45/2 An Duong Vuong, Q5, TpHCM', '0938435756', '19710110', 365000, '20061213')
INSERT INTO dbo.KHACKHANG VALUES('KH09', 'Le Ha Vinh', '873 Le Hong Phong, Q5, TpHCM', '08654763', '19790903', 70000, '20070114')
INSERT INTO dbo.KHACKHANG VALUES('KH10', 'Ha Duy Lap', '34/34B Nguyen Trai, Q1, TpHCM', '08768904', '19830502', 67500, '20070116')
...
ALTER TABLE dbo.KHACKHANG ADD LOAIKH TINYINT

UPDATE dbo.KHACKHANG SET HOTEN='Nguyen Van B' WHERE MAKH ='KH01';
UPDATE dbo.KHACKHANG SET HOTEN='Nguyen Van Hoan' WHERE MAKH ='KH09' AND YEAR(NGDK) = 2007 

ALTER TABLE dbo.SANPHAM ALTER COLUMN GHICHU VARCHAR(100)

ALTER TABLE dbo.SANPHAM DROP COLUMN GHICHU

DELETE FROM DBO.CTHD WHERE SOHD = 1001 OR SOHD=1002 OR SOHD=1005 OR SOHD=1006 OR SOHD=1008 OR SOHD=1010 OR SOHD=1019
Select * from HOADON
Select HOADON.SOHD from HOADON, CTHD WHERE HOADON.MAKH='KH01' and HOADON.SOHD = CTHD.SOHD

DElete from HOADON where HOADON.MAKH ='KH01'